...
describe('recipes-router', () => {
    ...
    describe('GET /api/recipes', () => {
        ...
        it('should respond with an array of recipes when logged in', async () => {
            const res = await supertest(server)
                .get('/api/recipes')
                .set({ Authorization: token })
              //  .then(res => {
        ...
        it('should respond with an array of recipes of same category if category query was provided when logged in', async () => {
            const res = await supertest(server)
    ...
    describe('GET /api/recipes/:id', () => {
        ...
        it('should respond with a recipe object', async () => {
            const res = await supertest(server)
                .get('/api/recipes/1')
                .set({ Authorization: token })
             //   .then(res => {
    ...
    describe('GET /api/recipes/recent/:limit', () => {
        ...
        it('should respond with an array of :limit number of recent recipes', async () => {
            const res = await supertest(server)
                .get('/api/recipes/recent/1')
                .set({ Authorization: token })
              //  .then(res => {
                    expect(res.body).toHaveLength(1)
              //  })
    ...
    describe('POST /api/recipes/:id/ingredients', () => {
        ...
        it('should respond with an ingredient object when all data provided', async () => {
            const res = await supertest(server)
    ...
    describe('POST /api/recipes/:id/allergies', () => {
        ...
        it('should respond with an allergy object when all data provided', async () => {
           const res = await supertest(server)
    ...
    describe('POST /api/recipes/:id/instructions', () => {
        ...
        it('should respond with status 401 UNAUTHOIRIZED and a message when not logged in', async () => {
            ...
            it('should respond with an instructions object when all data provided', async () => {
            const res = await supertest(server)
                .post('/api/recipes/1/instructions')
                .set({ Authorization: token })
                .send({ step_number:1, instructions: "yes"})
    ...
    describe('PUT /api/recipes/:id', async () => {
        ...
        it('should respond with status 401 UNAUTHOIRIZED and a message when not logged in', async () => {
            ...
            it('should respond with updated recipe object and a success message', async () => {
            const res = await supertest(server)
                .put('/api/recipes/1')
                .set({ Authorization: token })
                .send({title: 'testing'})
    ...
    describe('DELETE /api/recipes/:id', () => {
        ...
        it('should respond with delited recipe and a success message', async () => {
            const res = await supertest(server)
            .delete('/api/recipes/1')
            .set({ Authorization: token })
        //    .then( res => {
                expect(res.body.success).toBeDefined()
                expect(res.body.deletedRecipe.id).toBe(1)
        //    })
        })
    })
